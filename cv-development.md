...
- `2020-pres` User-facing Django application with admin interface wraps SVG files in HTML to publish immersive web content based on files exported from Adobe Illustrator
